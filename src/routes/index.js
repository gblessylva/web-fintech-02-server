...
const {homeRoute, getUsersRoute, getUserByID } = require('../controllers/getControllers');
...
//Edit User
router.patch('/api/v1/user/:id', patchUserByID )

//Delete Single User

router.delete('/api/v1/user/:id', deleteOneUser)
//Suspend user
